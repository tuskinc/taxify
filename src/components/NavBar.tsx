      ...
      <div className="page-container">
        <div className="h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="h-9 w-9 rounded-full bg-[#2563eb] text-white flex items-center justify-center font-bold">T</div>
            <span className="text-xl font-serif font-semibold text-[#111827]">Taxify</span>
          </div>
